...
const Nav = ({ navBar }) => {
    ...
    // const [arrowUtilities, setArrowUtilities] = useState(<i className="fa-solid fa-angle-right"></i>)
    ...
    //         setArrowUtilities(<i className="fa-solid fa-angle-up"></i>)
    //     } else {
    //         setDropNavUtilities('none')
    //         setArrowUtilities(<i className="fa-solid fa-angle-right"></i>)
    //     }
    // }
